            ...
            >
              <div className="recommended-products__card">
                <div className="recommended-products__image-container">
                  ...
                  <img src={product.image} alt={product.name} className="recommended-products__image" loading="lazy" />
                </div>
                ...
                <div className="recommended-products__content">
                  ...
                  <div className="recommended-products__price">
                    <span className="recommended-products__current-price">{formatPrice(product.currentPrice)}</span>
                    {product.listPrice > product.currentPrice && (
                      <span className="recommended-products__original-price">{formatPrice(product.listPrice)}</span>
                    )}
                  </div>
                  ...
                  {product.outOfStock ? (
                    ...
                    <button className="recommended-products__button" onClick={() => handleAddToCartClick(product)}>
                      Agregar
